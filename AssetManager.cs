...
public static class AssetManager
{
    ...
    {
        MelonLogger.Msg("Initializing Asset Manager");
        AssetBundle assetBundle;
        using (Stream bundleStream = Melon<MLEntrypoint>.Instance.MelonAssembly.Assembly.GetManifestResourceStream("SRLE.srle"))
        {
        ...
        if (ToolbarUI == null)
        {
            MelonLogger.Warning("AssetBundle failed to load.");
        }
