...
internal static class GetEntrypointType { public static System.Type type => typeof(SRLE.EntryPoint); }

// BuildInfo
internal static class BuildInfo
{
    internal const string Name = "SRLE"; // Name of the Expansion. 
    internal const string Description = "Build custom maps"; // Description for the Expansion.
    internal const string Author = "Atmudia"; // Author of the Expansion.
    internal const string CoAuthors = null; // CoAuthor(s) of the Expansion.  (optional, set as null if none)
    internal const string Contributors = "ThatFinn"; // Contributor(s) of the Expansion.  (optional, set as null if none)
