...
public class SRLECamera : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        kinematicCharacterMotor = SRSingleton<SceneContext>.Instance.Player.GetComponent<KinematicCharacterMotor>();
    ...
    public void OnEnable()
    {
        ...
        camera.fieldOfView = playerCamera.GetComponent<Camera>().fieldOfView;
